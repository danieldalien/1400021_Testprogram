...
class Hyamp():
    ...
    def fail_test(self):
        ...
        try:
            ...
            System_Fail_Test_Result = result[1]
            #tp_popup("Result ={0}".format(serialread))
            ...
            try:
                ...
                System_Fail_Test_Result = result[1]
                #p_popup("Result ={0}".format(serialread))
...
class runtime():  
    ...
    def Orientation_Cabinet(self):
        ...
        System_Origin_Coord[1] = P_Touch[1] #y Wert vom Origin gespeichert
        #self.c_modbus.set_digital_output_wait_input(12 , "go_bp")
        set_digital_output(-12)
        ...
        #pre_pos = posx()
        pre_pos[0] = 430
        pre_pos[1] = System_Origin_Coord[1] + 140.4 + 55 + 26
        #pre_pos[1] = 600
        pre_pos[2] = 850
    ...
    def Test_Cabinet(self , barcode ): #Testet angewähltes Cabinet
        ...
        global results
        global System_test_hyamp
        global Global_orientation_cabinet
        ...
        if Global_orientation_cabinet == 1 :
            self.Orientation_Cabinet()
        else:
            tp_popup("Attention, Robot will not perform Orientation Measurement")
...
def doSomething(command):
    ...
    global System_Ground_Offset_Result
    global user_input
    System_Fail_Test_Result = "None" 
    System_Ground_Offset_Result = "None"
    #perform fail check 
    #user_input = tp_get_user_input( "You want to perform a Fail Check ? " , input_type = DR_VAR_BOOL)
    fail_check()
    if user_input:
        tp_popup("Release the black cable")
        c_hyamp.fail_test()
    ...
    r = {
        ...
        "Ground Offset Result": System_Ground_Offset_Result,
        "Fail Check Result":System_Fail_Test_Result

            }
    json_offset_result = json.dumps(r)
    conn.sendall(json_offset_result.encode())
    ...
    tp_popup("Please connnect the black cable to the cabinet")
